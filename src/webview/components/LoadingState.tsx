export function LoadingState({ processed, total }: { processed: number; total: number }) {
  ...
  return (
    <div className="tw-flex tw-flex-col tw-items-center tw-justify-center tw-h-full tw-gap-3 tw-p-6">
      ...
      <p className="tw-text-[10px] tw-text-[var(--vscode-descriptionForeground)]">Scanning {processed} of {total} files</p>
    </div>
  );
}
